...
- (void)viewDidLoad {
	...
	metrics = [[NSMutableArray alloc] init];
	[metrics addObject:@"cpu"];
	[metrics addObject:@"memory"];
	[metrics addObject:@"disk"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [metrics objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[sortableTable reorderTableByMetric:[metrics objectAtIndex:indexPath.row]];
